...
public class GetDisconnectCheckQueryHandlerTests : IDisposable
{
    private readonly string _targetDirectory;

    public GetDisconnectCheckQueryHandlerTests()
    {
    ...
    [Fact]
    public async Task Handle_WhenFileExists_ReturnsDisconnectCheckResult()
    {
        // Arrange
        ...
        var handler = new GetDisconnectCheckQueryHandler();
        var query = new GetDisconnectCheckQuery();
